...
data class TopicFilter(val value: ByteBuffer) {
    ...
    val remainingSegments: TopicFilter? by lazy {
        ...
        TopicFilter(remainder.slice())
    }
}

@JvmInline
value class TopicFilterSegment(val value: ByteBuffer)